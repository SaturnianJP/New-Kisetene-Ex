...
bone_breast03_L
        */
        string Breast_Regex = "(?:B(?:reast(?:_(?:R(?:oot(?:\\.[LR]|_[LR]))?|root(?:\\.[LR]|_[LR])|1(?:\\.[LR]|_[LR])|2(?:\\.[LR]|_[LR])|L)|\\.[LR])|u(?:stDynamicBone\\.[LR]\\.001|tt_[LR]))|b(?:o(?:ob(?:_w\\.001_(?:L\\.00[123]|R\\.00[123])|s\\.[LR])|ne_breast0(?:1_[LR]|3_[LR]))|reast(?:\\.[LR]|_[LR])|ust\\.001\\.[LR])|Right(?: Breast(?:2(?:_end)?|1)|_Bust(?:End|2)?)|Left(?: Breast(?:2(?:_end)?|1)|_Bust(?:End|2)?))";
/*      
Hips_L
*/
...
Left Toes
            */
            { HumanBodyBones.LeftToes, "(?:Toe(?:Base_L|\\.[Ll]|_[Ll])|Left(?: Toes?|_?Toes)|toe(?:\\.[Ll]|_[Ll])|Foot\\.L\\.002|bone_toe_L)" },
...
Right Toes
            */
            { HumanBodyBones.RightToes, "(?:Toe(?:Base_R|\\.[Rr]|_[Rr])|Right(?: Toes?|_?Toes)|toe(?:\\.[Rr]|_[Rr])|Foot\\.R\\.002|bone_toe_R)" },
